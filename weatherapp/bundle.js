...
$(document).on('keyup', '.searchWeather', function () {
    ...
    var request = _axios2.default.get("http://api.wunderground.com/api/456615f4c4b28b63/forecast10day/q/CA/" + city + ".json");

    request.then(function (response) {
        console.log(response);
        // let cityName = 

        var days = response.forecast.simpleforecast.forecastday;

        days.forEach(function (day) {
            var dayElement = $('<div>');
            dayElement.addClass('col-12');
            var date = day.date.day + ' ' + day.date.monthname + ' ' + day.date.year;
            var highTemp = day.high.celsius;
            var lowTemp = day.low.celsius;
...
/***/function (module, exports, __webpack_require__) {
   ...
   */
  function isObject(val) {
    return val !== null && (typeof val === 'undefined' ? 'undefined' : _typeof6(val)) === 'object';
  }
  ...
  function forEach(obj, fn) {
    ...
    // Force an array if not already something iterable
    if ((typeof obj === 'undefined' ? 'undefined' : _typeof6(obj)) !== 'object' && !isArray(obj)) {
      /*eslint no-param-reassign:0*/
      obj = [obj];
    }
  ...
  function merge() /* obj1, obj2, obj3, ... */{
    var result = {};
    function assignValue(val, key) {
      if (_typeof6(result[key]) === 'object' && (typeof val === 'undefined' ? 'undefined' : _typeof6(val)) === 'object') {
        result[key] = merge(result[key], val);
      } else {
        result[key] = val;
      }
...
/***/function (module, exports, __webpack_require__) {
  ...
  /***/function (module, exports, __webpack_require__) {
     ...
     */
    function isObject(val) {
      return val !== null && (typeof val === 'undefined' ? 'undefined' : _typeof5(val)) === 'object';
    }
    ...
    function forEach(obj, fn) {
      ...
      // Force an array if not already something iterable
      if ((typeof obj === 'undefined' ? 'undefined' : _typeof5(obj)) !== 'object' && !isArray(obj)) {
        /*eslint no-param-reassign:0*/
        obj = [obj];
      }
    ...
    function merge() /* obj1, obj2, obj3, ... */{
      var result = {};
      function assignValue(val, key) {
        if (_typeof5(result[key]) === 'object' && (typeof val === 'undefined' ? 'undefined' : _typeof5(val)) === 'object') {
          result[key] = merge(result[key], val);
        } else {
          result[key] = val;
        }
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    $(document).on('keyup', '.searchWeather', function () {
      ...
      //     let days = response.forecast.simpleforecast.forecastday;    
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    /***/function (module, exports, __webpack_require__) {
       ...
       */
      function isObject(val) {
        return val !== null && (typeof val === 'undefined' ? 'undefined' : _typeof4(val)) === 'object';
      }
      ...
      function forEach(obj, fn) {
        ...
        // Force an array if not already something iterable
        if ((typeof obj === 'undefined' ? 'undefined' : _typeof4(obj)) !== 'object' && !isArray(obj)) {
          /*eslint no-param-reassign:0*/
          obj = [obj];
        }
      ...
      function merge() /* obj1, obj2, obj3, ... */{
        var result = {};
        function assignValue(val, key) {
          if (_typeof4(result[key]) === 'object' && (typeof val === 'undefined' ? 'undefined' : _typeof4(val)) === 'object') {
            result[key] = merge(result[key], val);
          } else {
            result[key] = val;
          }
    ...
    /***/function (module, exports, __webpack_require__) {
      ...
      /***/function (module, exports, __webpack_require__) {
        ...
        function forEach(obj, fn) {
          ...
          // Force an array if not already something iterable
          if ((typeof obj === 'undefined' ? 'undefined' : _typeof3(obj)) !== 'object' && !isArray(obj)) {
            /*eslint no-param-reassign:0*/
            obj = [obj];
          }
